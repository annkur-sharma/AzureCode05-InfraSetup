...
storage_account_name = "ankur01storage01a1"                      # Example: "rgbackendtorageaccount"
container_name       = "ankur01storage01a1container"             # Example: "rgbackendstoragecontainer"
key                  = "AzureCode05-Infra.terraform.tfstate"     # Example: "infra01.terraform.tfstate"